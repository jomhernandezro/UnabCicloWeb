...
route.post("/", auth_1["default"], insert_params.evento, insertit.logic_evento);
route.get("/all", auth_1["default"], getters.logic_evento);
route.get("/", auth_1["default"], id_param_1["default"], getit.logic_evento);
route.put("/", auth_1["default"], insert_params.evento, insertit.logic_evento);
route["delete"]("/", auth_1["default"], id_param_1["default"], deleteit.logic_evento);

    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, deporte_1["default"].findById({ _id: id })["catch"](function (err) {
                        console.log(err);
...
var logic_equipo = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = (_a = request === null || request === void 0 ? void 0 : request.body) === null || _a === void 0 ? void 0 : _a.id;
                return [4 /*yield*/, equipo_1["default"].findById({ _id: id })["catch"](function (err) {
                        console.log(err);
                        response.status(500).json("server error");
                    })];
            case 1:
...
var logic_evento = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = (_a = request === null || request === void 0 ? void 0 : request.body) === null || _a === void 0 ? void 0 : _a.id;
                return [4 /*yield*/, evento_1["default"].findById({ _id: id })["catch"](function (err) {
                        console.log(err);
                        response.status(500).json("server error");
                    })];
            case 1:
